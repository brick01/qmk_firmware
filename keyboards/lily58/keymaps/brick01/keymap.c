 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  KC_ESC,   KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,                    KC_F8,   KC_F9,   KC_10,   KC_F11,  KC_F12,   KC_DEL,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
